...
class AbandonedQuarryLogic : IMissionLogic
{
    ...
    public AbandonedQuarryLogic()
    {
        firstPower = this.Location(1);
        firstLava = this.Location(2);
        firstPollution = this.Location(4);
        firstGreenery = this.Location(5);
        firstWater = this.Location(3);
        firstFire = this.Location(13);
        t1p25 = this.Location(6);
        t1p50 = this.Location(7);
        t1p75 = this.Location(8);
        t1p100 = this.Location(9);
        ...
        names.Add("Salmon", this.Location(35));
        names.Add("WeatherRestored", this.Location(36));
    }

    public Mission Target()
    {
        return Mission.TemperateQuarry;
    }
